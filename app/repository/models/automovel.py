...
class Automovel(Base):
    ...
    tipo_combustivel = Column(Enum(TipoCombustivel, name="tipo_combustivel_enum"), nullable=False)
    ...
    def __repr__(self):
        return f"<Automovel(id={self.id}, modelo='{self.modelo}', chassi={self.chassi})>"
